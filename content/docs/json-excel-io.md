---
title: "JSON & Excel I/O"
description: "Read and write DataFrames as JSON records and Excel (.xlsx) spreadsheets"
icon: "import_export"
weight: 32
---

Learn how to load and export DataFrames as JSON and Excel files in GPandas. JSON is read and written in records orientation; Excel support is powered by [excelize](https://github.com/xuri/excelize).
...
Excel support depends on [`github.com/xuri/excelize/v2`](https://github.com/xuri/excelize), which is pulled in automatically via `go get`. JSON I/O uses only the Go standard library.
